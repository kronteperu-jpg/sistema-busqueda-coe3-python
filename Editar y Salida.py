...
# ==========================================
    ...
    # ==========================================
        ...
        print("\n===== EDITAR EFECTIVO POLICIAL =====")
        dni_buscar = input("Ingrese DNI del policía: ")

        encontrado = False

        for policia in policias:

            if policia["dni"] == dni_buscar:
                ...
                print("\n--- NUEVOS DATOS (ENTER para no modificar) ---")

                nuevo_nombre = input("Nuevo nombre: ")
                nuevo_cip = input("Nuevo CIP: ")
                nuevo_rango = input("Nuevo rango: ")

                if nuevo_nombre != "":
                    policia["nombre"] = nuevo_nombre

                if nuevo_cip != "":
                    policia["cip"] = nuevo_cip

                if nuevo_rango != "":
                    policia["rango"] = nuevo_rango
    ...
    # ==========================================
        ...
        print("\n===== EDITAR SERENO =====")
        dni_buscar = input("Ingrese DNI del sereno: ")

        encontrado = False

        for sereno in serenos:

            if sereno["dni"] == dni_buscar:

                print("\nSereno encontrado:")
                print("Nombre:", sereno["nombre"])

                print("\n--- NUEVO DATO (ENTER para no modificar) ---")

                nuevo_nombre = input("Nuevo nombre: ")

                if nuevo_nombre != "":
                    sereno["nombre"] = nuevo_nombre
